...
// // ============================================================
// // 🧪 TEST EMAIL ROUTE (Direct SMTP Debug)
// // ============================================================
...
//     const testRecipient = process.env.BACKUP_EMAIL || 'hrms@myras.in';
//     const result = await emailService.sendBackupEmailTo(
//       testRecipient,
//       Buffer.from('This is a test email from panic wipe debug.'),
//       'test.txt',
...
// ============================================================
// ⭐ TEST BACKUP ROUTE (Direct Email — No DB Query) ⭐
// ============================================================
app.post('/api/backup/test', async (req: Request, res: Response) => {
  try {
    const adminSecret = req.headers['x-admin-secret'];
    ...
    // ✅ Direct email — NO DATABASE FETCH
    const result = await emailService.sendBackupEmailTo(
      process.env.BACKUP_EMAIL || 'hrms@myras.in',
      Buffer.from('This is a test backup email from your IVF app.'),
      `test_backup_${Date.now()}.enc`,
      '🧪 Test Backup Email'
    );
